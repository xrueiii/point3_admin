    ...
    <>
      <div className="bg-black justify-center min-h-screen w-screen items-center">
        <div className="w-full py-4 bg-amber-100 items-center flex px-16 justify-between">
          <h1 className="font-serif text-2xl lg:text-5xl font-medium animate-pulse-short delay-100">0.3 練團室後台管理系統</h1>
          <Image src="/Logo.png" alt="logo_pic" width={100} height={30} className="animate-pulse-short delay-100"/>
        </div>
